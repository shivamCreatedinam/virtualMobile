        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <View style={styles.mainContainer}>
                    ...
                    <TouchableOpacity style={{ marginLeft: 20,marginTop:5}} onPress={()=> navigation.navigate("ringtone")}>
                    ...
                    <View style={{ marginLeft: 18, marginTop: 20 }}>
                        ...
                        <Text style={{ color: colors.OffWhite, fontSize: 16, paddingBottom: 20 }}>radiate</Text>
                    </View>
                    <View style={{ marginLeft: 18, marginTop: 15 }}>
                        <Text style={{ color: colors.white, fontSize: 18 }}>Feedback</Text>
                    </View>
                    <View style={{ marginLeft: 18, marginTop: 20 }}>
                        <Text style={{ color: colors.white, fontSize: 20 }}>Charging meter</Text>
                        <Text style={{ color: colors.OffWhite, fontSize: 16, paddingBottom: 20 }}>On</Text>
                    </View>
                    <View style={{ marginLeft: 18, marginTop: 5 }}>
                        <Text style={{ color: colors.white, fontSize: 20 }}>Google assistant feedback</Text>
                        <Text style={{ color: colors.OffWhite, fontSize: 16, paddingBottom: 20 }}>On</Text>
                    </View>
                    <View style={{ marginLeft: 18, marginTop: 5 }}>
                        <Text style={{ color: colors.white, fontSize: 16 }}>Advanced features</Text>
                    </View>
                </View>
